 ...
 */
final class Version20181214152605 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, offer_id INT NOT NULL, template_id INT NOT NULL, user_id INT NOT NULL, discount INT DEFAULT NULL, status VARCHAR(32) NOT NULL, viewed VARCHAR(32) NOT NULL, INDEX IDX_E52FFDEE53C674EE (offer_id), INDEX IDX_E52FFDEE5DA0FB8 (template_id), INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, offer_id INT NOT NULL, text VARCHAR(1000) NOT NULL, username VARCHAR(50) NOT NULL, date DATETIME NOT NULL, INDEX IDX_B6BD307F53C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offer_position_template (id INT AUTO_INCREMENT NOT NULL, position_id INT NOT NULL, offer_id INT NOT NULL, offer_template_id INT NOT NULL, count INT NOT NULL, price INT NOT NULL, INDEX IDX_B6B6DF53DD842E46 (position_id), INDEX IDX_B6B6DF5353C674EE (offer_id), INDEX IDX_B6B6DF5384F8B3B6 (offer_template_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, md5 VARCHAR(32) NOT NULL, client_email VARCHAR(100) NOT NULL, client_name VARCHAR(100) NOT NULL, message VARCHAR(1000) NOT NULL, status VARCHAR(32) NOT NULL, viewed VARCHAR(32) NOT NULL, INDEX IDX_29D6873EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE offer_position_template ADD CONSTRAINT FK_B6B6DF53DD842E46 FOREIGN KEY (position_id) REFERENCES position (id)');
        $this->addSql('ALTER TABLE offer_position_template ADD CONSTRAINT FK_B6B6DF5353C674EE FOREIGN KEY (offer_id) REFERENCES offer (id)');
        $this->addSql('ALTER TABLE offer_position_template ADD CONSTRAINT FK_B6B6DF5384F8B3B6 FOREIGN KEY (offer_template_id) REFERENCES offer_template (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offer_position_template DROP FOREIGN KEY FK_B6B6DF53DD842E46');
        ...
        $this->addSql('ALTER TABLE offer_position_template DROP FOREIGN KEY FK_B6B6DF5353C674EE');
        $this->addSql('ALTER TABLE offer_template DROP FOREIGN KEY FK_EE1DAFE153C674EE');
        $this->addSql('ALTER TABLE offer_position_template DROP FOREIGN KEY FK_B6B6DF5384F8B3B6');
        ...
        $this->addSql('DROP TABLE offer_position_template');
